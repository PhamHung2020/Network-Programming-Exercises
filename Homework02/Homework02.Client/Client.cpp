...
int main(int argc, char* argv[]) {
	...
	while (1) {
		...
		//get user choice depending on login status
		if (!isLogin)
		{
			userChoice = InputHandler::inputIntInRange("\nSelect function: ", 1, 2);
			if (userChoice == 1) //user chooses login
			{
		...
		//Receive message from server part
		while (1)
		{
